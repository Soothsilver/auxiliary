...
namespace FMOD
{
...
#if WIN64
        public const string dll    = "fmod\\fmodex64";
#else
        public const string dll    = "fmod\\fmodex";
#endif
    }
    ...
    */
    public enum RESULT :int
    {
        ...
        ERR_OUTPUT_DRIVERCALL,     /* A call to a standard soundcard driver failed, which could possibly mean a programming error in the driver or resources were missing or exhausted. */
