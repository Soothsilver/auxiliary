...
namespace Auxiliary.GUI
{
    ...
    {  
        ...
        public override void Draw()
        {
            ...
            Primitives.DrawMultiLineText(txt + (Root.SecondsSinceStartInt % 2 == 0 && IsActive ? "|" : ""), new Rectangle(InnerRectangle.X + 8, InnerRectangle.Y + 3, InnerRectangle.Width - 10, InnerRectangle.Height - 4), textColor, Skin.Font);
        }
        /// <summary>
