...
1. Add the "Auxiliary", "AuxiliaryContent" and "Cother" projects to your solution. Add "Auxiliary" and "Cother" as references to your project.
2. At program startup, call the Root.Init() static method with appropriate parameters (see the example game, HelloAuxiliary).
